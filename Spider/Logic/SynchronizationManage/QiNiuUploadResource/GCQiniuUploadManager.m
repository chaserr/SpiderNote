...
//}
//
//- (void)createDownLoadToken:(NSString *)fileName{
//
//    if (!self.scope.length || !self.accessKey.length || !self.secretKey.length) {
//        return;
//    }
//    
//    NSDate* dat = [NSDate dateWithTimeIntervalSinceNow:24*60*60*2];
//    NSTimeInterval a=[dat timeIntervalSince1970]*1000;
//    NSString *timeString = [NSString stringWithFormat:@"%f", a];
//    
//    NSString *downloadUrl = [NSString stringWithFormat:@"http://7xozpn.com2.z0.glb.qiniucdn.com/resource/%@.jpg?e=%@",fileName, timeString];
//    
//    NSString *sign = [self HMACSHA1:downloadUrl text:self.secretKey];
//    NSString *encodingUrl = [self urlSafeBase64Encode:[sign dataUsingEncoding:(NSUTF8StringEncoding)]];
//    NSString *token = [NSString stringWithFormat:@"%@:%@", self.accessKey, encodingUrl];
//    NSString *realyDownloadUrl = [NSString stringWithFormat:@"%@&token=%@", downloadUrl, token];
//    
//    self.downloadToken = realyDownloadUrl;
//}
//
